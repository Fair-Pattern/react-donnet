...
{
    public abstract class react-dot-netWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static react-dot-netWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(react-dot-netWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<react-dot-netDbContext> action)
        {
            using (var context = IocManager.Resolve<react-dot-netDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<react-dot-netDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<react-dot-netDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<react-dot-netDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<react-dot-netDbContext, Task<T>> func)
        {
            T result;
